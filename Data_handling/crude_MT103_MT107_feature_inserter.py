...
# 				ixs103mod.append(l)
#
# 		dummy_df = ENDFBVIII_MT16[ENDFBVIII_MT16.Z == nuclide[0]]
...
# 	elif nuclide not in nucs103:
# 		dummy_df2 = ENDFBVIII_MT16[ENDFBVIII_MT16.Z == nuclide[0]]
...
# MT107_df = pd.DataFrame(columns=['Z', 'A', 'MT107XS', 'ERG'])
