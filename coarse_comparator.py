...
al = range_setter(la=30, ua=260, df=df)
...
X_train, y_train = make_train(df=df, validation_nuclides=validation_nuclides, la=30, ua=260,
							  exclusions=exc) # create training matrix
X_test, y_test = make_test(validation_nuclides, df=TENDL,) # create test matrix using validation nuclides
