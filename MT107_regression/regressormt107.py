...
# CENDL_32 = pd.read_csv('CENDL32_MT16_with_ENDFB_MT103_107.csv')
...
#
# JENDL_5 = pd.read_csv('JENDL5_with_MT16_and_ENDFB_MT103_107.csv')
# JENDL_nuclides = range_setter(df=JENDL_5, la=0, ua=208)
#
# TENDL_2021 = pd.read_csv('TENDL_2021_MT16_with_ENDFB_MT103_107.csv')
