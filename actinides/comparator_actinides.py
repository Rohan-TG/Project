...
TENDL_nuclides = range_setter(df=TENDL, la=208, ua=260)

JEFF = pd.read_csv('/Users/rntg/PycharmProjects/Project/JEFF33_all_features.csv')
JEFF.index = range(len(JEFF))
JEFF_nuclides = range_setter(df=JEFF, la=208, ua=260)

JENDL = pd.read_csv('/Users/rntg/PycharmProjects/Project/JENDL5_arange_all_features.csv')
JENDL.index = range(len(JENDL))
JENDL_nuclides = range_setter(df=JENDL, la=208, ua=260)

CENDL = pd.read_csv('/Users/rntg/PycharmProjects/Project/CENDL32_all_features.csv')
CENDL.index = range(len(CENDL))
CENDL_nuclides = range_setter(df=CENDL, la=208, ua=260)
...
al = range_setter(la=220, ua=230, df=df)
...
X_train, y_train = make_train(df=df, validation_nuclides=validation_nuclides, la=220, ua=240,
							  exclusions=exc) # create training matrix
X_test, y_test = make_test(validation_nuclides, df=JENDL,) # create test matrix using validation nuclides
...
for n in validation_nuclides:
	...
	temp_x, temp_y = make_test(nuclides=[n], df=JENDL)
