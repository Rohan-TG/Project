...
import pandas as pd
import numpy as np
from MT_103_functions import make_test, make_train, range_setter
...
ENDFBVIII = pd.read_csv("ENDFBVIII_MT_103_all_features.csv")
TENDL21 = pd.read_csv("TENDL-2021_MT_103_all_features.csv")
JENDL5 = pd.read_csv("JENDL-5_MT_103_all_features.csv")

print("Libraries loaded")

ENDFB_nuclides = range_setter(df=ENDFBVIII, la=30, ua=208)
TENDL21_nuclides = range_setter(df=TENDL21, la=30, ua=208)
